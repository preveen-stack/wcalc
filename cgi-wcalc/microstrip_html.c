...
fprintf(cgiOut,"<!-- $Id: microstrip.html,v 1.13 2009/02/11 00:00:29 dan Exp $ -->\n");
fprintf(cgiOut,"<!--\n");
...
fprintf(cgiOut,"<HTML>\n");
fprintf(cgiOut,"<HEAD>\n");
fprintf(cgiOut,"<TITLE>Microstrip Analysis/Synthesis</TITLE>\n");
...
fprintf(cgiOut,"<meta name=\"description\" content=\"Microstrip Analysis/Synthesis\">\n");
fprintf(cgiOut,"<meta name=\"keywords\" content=\"\n");
fprintf(cgiOut,"microstrip\n");
fprintf(cgiOut,"\">\n");
fprintf(cgiOut,"%s\n",cgi_units_menu_init());
fprintf(cgiOut,"</HEAD>\n");
fprintf(cgiOut,"\n");
...
fprintf(cgiOut,"\n");
fprintf(cgiOut,"<H1 ALIGN=\"CENTER\">Microstrip Analysis/Synthesis Calculator</H1>\n");
fprintf(cgiOut,"\n");
fprintf(cgiOut,"<P>\n");
fprintf(cgiOut,"\n");
fprintf(cgiOut,"\n");
fprintf(cgiOut,"<FORM NAME=\"wcalc\" METHOD=GET ACTION=\"microstrip.cgi\">\n");
...
fprintf(cgiOut,"<TD><IMG SRC=\"%smicrostrip_model.png\" WIDTH=287 HEIGHT=125\n",HTMLPATH);
fprintf(cgiOut,"     ALT=\"[Microstrip Circuit Model]\"></TD>\n");
fprintf(cgiOut,"</TR>\n");
fprintf(cgiOut,"\n");
fprintf(cgiOut,"<TR ALIGN=\"CENTER\">\n");
...
fprintf(cgiOut,"\n");
fprintf(cgiOut,"<TR ALIGN=\"CENTER\">\n");
fprintf(cgiOut,"<TD><IMG SRC=\"%smicrostrip.png\" WIDTH=366 HEIGHT=184\n",HTMLPATH);
fprintf(cgiOut,"     ALT=\"[Microstrip Cross-section]\"></TD>\n");
fprintf(cgiOut,"</TR>\n");
fprintf(cgiOut,"\n");
fprintf(cgiOut,"<TR>\n");
fprintf(cgiOut,"<TD>\n");
