...
fprintf(cgiOut,"<!-- $Id: coupled_microstrip.html,v 1.16 2009/02/11 00:00:28 dan Exp $ -->\n");
fprintf(cgiOut,"<!--\n");
fprintf(cgiOut," * Copyright (c) 2001, 2002, 2003, 2004, 2005 Dan McMahill\n");
...
fprintf(cgiOut,"<HTML>\n");
fprintf(cgiOut,"<HEAD>\n");
fprintf(cgiOut,"<TITLE>Coupled Microstrip Analysis/Synthesis</TITLE>\n");
...
fprintf(cgiOut,"<meta name=\"description\" content=\"Coupled Microstrip Analysis/Synthesis\">\n");
...
fprintf(cgiOut,"\n");
fprintf(cgiOut,"<H1 ALIGN=\"CENTER\">Coupled Microstrip Analysis/Synthesis Calculator</H1>\n");
fprintf(cgiOut,"\n");
fprintf(cgiOut,"<P>\n");
fprintf(cgiOut,"\n");
fprintf(cgiOut,"\n");
fprintf(cgiOut,"<FORM NAME=\"wcalc\" METHOD=GET ACTION=\"coupled_microstrip.cgi\">\n");
...
fprintf(cgiOut,"<TD><IMG SRC=\"%scoupled_microstrip.png\" WIDTH=374 HEIGHT=184 \n",HTMLPATH);
fprintf(cgiOut,"     ALT=\"[Coupled Microstrip Cross-section]\"></TD>\n");
fprintf(cgiOut,"</TR>\n");
fprintf(cgiOut,"\n");
fprintf(cgiOut,"<TR ALIGN=\"CENTER\">\n");
...
fprintf(cgiOut,"\n");
fprintf(cgiOut,"<TR>\n");
fprintf(cgiOut,"<TD>keven =</TD>\n");
fprintf(cgiOut,"<TD>%g</TD>\n",line->kev);
fprintf(cgiOut,"<TD>[-]</TD>\n");
fprintf(cgiOut,"</TR>\n");
fprintf(cgiOut,"\n");
fprintf(cgiOut,"<TR>\n");
fprintf(cgiOut,"<TD>kodd =</TD>\n");
fprintf(cgiOut,"<TD>%g</TD>\n",line->kodd);
fprintf(cgiOut,"<TD>[-]</TD>\n");
fprintf(cgiOut,"</TR>\n");
fprintf(cgiOut,"\n");
