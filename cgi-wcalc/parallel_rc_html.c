...
fprintf(cgiOut,"<!-- $Id: parallel_rc.html,v 1.1 2009/02/11 00:00:31 dan Exp $ -->\n");
fprintf(cgiOut,"<!--\n");
...
fprintf(cgiOut,"<HTML>\n");
fprintf(cgiOut,"<HEAD>\n");
fprintf(cgiOut,"<TITLE>Series/Parallel RC Network Conversion</TITLE>\n");
...
fprintf(cgiOut,"<meta name=\"description\" content=\"Series/Parallel RC Network Conversion\">\n");
...
fprintf(cgiOut,"\n");
fprintf(cgiOut,"<H1 ALIGN=\"CENTER\">Series/Parallel RC Network Conversion Calculator</H1>\n");
fprintf(cgiOut,"\n");
fprintf(cgiOut,"<P>\n");
fprintf(cgiOut,"\n");
fprintf(cgiOut,"\n");
fprintf(cgiOut,"<FORM NAME=\"wcalc\" METHOD=GET ACTION=\"parallel_rc.cgi\">\n");
...
fprintf(cgiOut,"<TD><IMG SRC=\"%src.png\" WIDTH=551 HEIGHT=168\n",HTMLPATH);
fprintf(cgiOut,"     ALT=\"[Series/Parallel RC Network Schematic]\"></TD>\n");
fprintf(cgiOut,"</TR>\n");
fprintf(cgiOut,"\n");
fprintf(cgiOut,"<TR ALIGN=\"CENTER\">\n");
...
fprintf(cgiOut,"<TD><INPUT TYPE=\"TEXT\" SIZE=10 NAME=\"Cs\" VALUE=\"%g\"\n",line->Cs/line->units_C->sf);
...
fprintf(cgiOut,"\n");
fprintf(cgiOut,"<TR>\n");
fprintf(cgiOut,"<TD>Cp</TD>\n");
fprintf(cgiOut,"<TD><INPUT TYPE=\"TEXT\" SIZE=10 NAME=\"Cp\" VALUE=\"%g\"\n",line->Cp/line->units_C->sf);
fprintf(cgiOut,"           onChange=\"valsChanged()\"></TD>\n");
fprintf(cgiOut,"<TD>	   \n");
...
fprintf(cgiOut,"<TD>Q/C<INPUT TYPE=\"RADIO\" NAME=\"stype\" VALUE=\"use_Q\" %s\n",use_Q_checked);
fprintf(cgiOut,"           onChange=\"valsChanged()\"></TD>\n");
fprintf(cgiOut,"<TD>R/C<INPUT TYPE=\"RADIO\" NAME=\"stype\" VALUE=\"use_R\" %s\n",use_R_checked);
fprintf(cgiOut,"           onChange=\"valsChanged()\"></TD>\n");
fprintf(cgiOut,"</TR>\n");
fprintf(cgiOut,"\n");
fprintf(cgiOut,"<TR>\n");
