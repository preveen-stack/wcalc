...
void ic_microstrip_eps(FILE *fp)
{
...
fprintf(fp,"%%\n");
fprintf(fp,"currentpoint 784 653 sub sub\n");
fprintf(fp,"gsave\n");
fprintf(fp,"currentpoint pop 88 331 add 2 div sub\n");
fprintf(fp,"currentpoint exch pop 784 sub \n");
...
fprintf(fp,"%%%%BoundingBox: 88 653 331 784\n");
fprintf(fp,"%%%%Title: ic_microstrip\n");
...
fprintf(fp,"   TGSM\n");
fprintf(fp,"   NP\n");
fprintf(fp,"      464 200 8.000 3.000 -24 0 TGAT\n");
fprintf(fp,"   1 SG CP F\n");
fprintf(fp,"   0 SG\n");
fprintf(fp,"   NP\n");
fprintf(fp,"      464 200 8.000 3.000 -24 0 TGAT\n");
...
fprintf(fp,"GS\n");
fprintf(fp,"   NP\n");
fprintf(fp,"      472 152 M\n");
fprintf(fp,"      0 24 atan DU cos 8.000 MU exch sin 8.000 MU RM\n");
fprintf(fp,"      496 152 L\n");
fprintf(fp,"   TGSM\n");
fprintf(fp,"   1 W\n");
fprintf(fp,"   S\n");
fprintf(fp,"GR\n");
...
fprintf(fp,"   TGSM\n");
fprintf(fp,"   NP\n");
fprintf(fp,"      472 152 8.000 3.000 -24 0 TGAT\n");
fprintf(fp,"   1 SG CP F\n");
fprintf(fp,"   0 SG\n");
fprintf(fp,"   NP\n");
fprintf(fp,"      472 152 8.000 3.000 -24 0 TGAT\n");
...
fprintf(fp,"   TGSM\n");
fprintf(fp,"   NP\n");
fprintf(fp,"      168 112 8.000 3.000 0 16 TGAT\n");
fprintf(fp,"   1 SG CP F\n");
fprintf(fp,"   0 SG\n");
fprintf(fp,"   NP\n");
fprintf(fp,"      168 112 8.000 3.000 0 16 TGAT\n");
...
fprintf(fp,"GS\n");
fprintf(fp,"   NP\n");
fprintf(fp,"      168 128 M\n");
fprintf(fp,"      16 0 atan DU cos 8.000 MU exch sin 8.000 MU RM\n");
fprintf(fp,"      168 144 L\n");
fprintf(fp,"   TGSM\n");
fprintf(fp,"   1 W\n");
fprintf(fp,"   S\n");
fprintf(fp,"GR\n");
...
fprintf(fp,"   TGSM\n");
fprintf(fp,"   NP\n");
fprintf(fp,"      168 128 8.000 3.000 0 -16 TGAT\n");
fprintf(fp,"   1 SG CP F\n");
fprintf(fp,"   0 SG\n");
fprintf(fp,"   NP\n");
fprintf(fp,"      168 128 8.000 3.000 0 -16 TGAT\n");
...
fprintf(fp,"GS\n");
fprintf(fp,"   NP\n");
fprintf(fp,"      160 112 M\n");
fprintf(fp,"      176 112 L\n");
fprintf(fp,"   TGSM\n");
fprintf(fp,"   1 W\n");
fprintf(fp,"   S\n");
fprintf(fp,"GR\n");
...
fprintf(fp,"          0 RM\n");
fprintf(fp,"            0 SG\n");
fprintf(fp,"            /Helvetica FF [24 0 0 -24 0 0] MS\n");
fprintf(fp,"            (, ) SH\n");
fprintf(fp,"            0 SG\n");
fprintf(fp,"            /Symbol FF [24 0 0 -24 0 0] MS\n");
fprintf(fp,"            (s) SH\n");
...
fprintf(fp,"NP\n");
fprintf(fp,"0 SG\n");
fprintf(fp,"NP 503 23 M 548 23 L 548 46 L 503 46 L CP 1 SG F\n");
fprintf(fp,"0 SG\n");
fprintf(fp,"   GS\n");
fprintf(fp,"      1 W\n");
fprintf(fp,"      504 42 M\n");
...
fprintf(fp,"NP\n");
fprintf(fp,"0 SG\n");
fprintf(fp,"NP 503 220 M 547 220 L 547 243 L 503 243 L CP 1 SG F\n");
fprintf(fp,"0 SG\n");
fprintf(fp,"   GS\n");
fprintf(fp,"      1 W\n");
fprintf(fp,"      504 239 M\n");
fprintf(fp,"      GS\n");
fprintf(fp,"            0 SG\n");
fprintf(fp,"            /Helvetica FF [20 0 0 -20 0 0] MS\n");
fprintf(fp,"            (GND) SH\n");
...
fprintf(fp,"   GS\n");
fprintf(fp,"      1 W\n");
fprintf(fp,"      504 111 M\n");
fprintf(fp,"      GS\n");
fprintf(fp,"            0 SG\n");
fprintf(fp,"            /Helvetica FF [20 0 0 -20 0 0] MS\n");
fprintf(fp,"            (Dielectric) SH\n");
fprintf(fp,"      GR\n");
fprintf(fp,"   GR\n");
fprintf(fp,"\n");
fprintf(fp,"%% TEXT\n");
fprintf(fp,"NP\n");
fprintf(fp,"0 SG\n");
fprintf(fp,"NP 159 76 M 193 76 L 193 99 L 159 99 L CP 1 SG F\n");
fprintf(fp,"0 SG\n");
fprintf(fp,"   GS\n");
fprintf(fp,"      1 W\n");
fprintf(fp,"      160 95 M\n");
...
fprintf(fp,"\n");
fprintf(fp,"%% POLYGON/CLOSED-SPLINE\n");
fprintf(fp,"0.398 0.398 0.398 RG\n");
fprintf(fp,"NP\n");
fprintf(fp,"   368 112 M\n");
fprintf(fp,"   472 48 L\n");
fprintf(fp,"   544 48 L\n");
fprintf(fp,"   448 112 L\n");
fprintf(fp,"CP\n");
fprintf(fp,"GS\n");
fprintf(fp,"   EF\n");
fprintf(fp,"GR\n");
...
fprintf(fp,"%% BOX\n");
fprintf(fp,"0.398 0.398 0.398 RG\n");
fprintf(fp,"NP 184 112 M 448 112 L 448 128 L 184 128 L CP F\n");
fprintf(fp,"GS\n");
fprintf(fp,"   10 SM\n");
fprintf(fp,"   GS\n");
fprintf(fp,"      NP 184 112 M 448 112 L 448 128 L 184 128 L CP\n");
fprintf(fp,"      S\n");
fprintf(fp,"   GR\n");
fprintf(fp,"GR\n");
fprintf(fp,"\n");
...
fprintf(fp,"%% BOX\n");
fprintf(fp,"0.266 0.266 0.266 RG\n");
fprintf(fp,"NP 272 96 M 368 96 L 368 112 L 272 112 L CP F\n");
fprintf(fp,"GS\n");
fprintf(fp,"   10 SM\n");
fprintf(fp,"   GS\n");
fprintf(fp,"      NP 272 96 M 368 96 L 368 112 L 272 112 L CP\n");
fprintf(fp,"      S\n");
fprintf(fp,"   GR\n");
fprintf(fp,"GR\n");
fprintf(fp,"\n");
...
fprintf(fp,"      exch sin 8.000 MU 32 exch SU L\n");
fprintf(fp,"   TGSM\n");
fprintf(fp,"   1 W\n");
fprintf(fp,"   S\n");
fprintf(fp,"GR\n");
...
fprintf(fp,"   TGSM\n");
fprintf(fp,"   NP\n");
fprintf(fp,"      256 96 8.000 3.000 -104 64 TGAT\n");
fprintf(fp,"   1 SG CP F\n");
fprintf(fp,"   0 SG\n");
fprintf(fp,"   NP\n");
fprintf(fp,"      256 96 8.000 3.000 -104 64 TGAT\n");
...
fprintf(fp,"   TGSM\n");
fprintf(fp,"   NP\n");
fprintf(fp,"      360 32 8.000 3.000 104 -64 TGAT\n");
fprintf(fp,"   1 SG CP F\n");
fprintf(fp,"   0 SG\n");
fprintf(fp,"   NP\n");
fprintf(fp,"      360 32 8.000 3.000 104 -64 TGAT\n");
...
fprintf(fp,"GS\n");
fprintf(fp,"   NP\n");
fprintf(fp,"      496 152 M\n");
fprintf(fp,"      496 192 L\n");
fprintf(fp,"      504 192 L\n");
fprintf(fp,"   TGSM\n");
fprintf(fp,"   1 W\n");
fprintf(fp,"   S\n");
fprintf(fp,"GR\n");
...
fprintf(fp,"GS\n");
fprintf(fp,"   NP\n");
fprintf(fp,"      488 200 M\n");
fprintf(fp,"      488 232 L\n");
fprintf(fp,"      504 232 L\n");
fprintf(fp,"   TGSM\n");
fprintf(fp,"   1 W\n");
fprintf(fp,"   S\n");
fprintf(fp,"GR\n");
...
fprintf(fp,"   TGSM\n");
fprintf(fp,"   NP\n");
fprintf(fp,"      488 32 8.000 3.000 0 16 TGAT\n");
fprintf(fp,"   1 SG CP F\n");
fprintf(fp,"   0 SG\n");
fprintf(fp,"   NP\n");
fprintf(fp,"      488 32 8.000 3.000 0 16 TGAT\n");
...
fprintf(fp,"GS\n");
fprintf(fp,"   NP\n");
fprintf(fp,"      472 104 M\n");
fprintf(fp,"      0 24 atan DU cos 8.000 MU exch sin 8.000 MU RM\n");
fprintf(fp,"      496 104 L\n");
fprintf(fp,"   TGSM\n");
fprintf(fp,"   1 W\n");
fprintf(fp,"   S\n");
fprintf(fp,"GR\n");
...
fprintf(fp,"   TGSM\n");
fprintf(fp,"   NP\n");
fprintf(fp,"      472 104 8.000 3.000 -24 0 TGAT\n");
fprintf(fp,"   1 SG CP F\n");
fprintf(fp,"   0 SG\n");
fprintf(fp,"   NP\n");
fprintf(fp,"      472 104 8.000 3.000 -24 0 TGAT\n");
